...
class CRM_Booking_Flow_Shortcodes {
    ...
    public function ajax_submit() {
        ...
        if (!crm_booking_validate_recaptcha_ajax('booking_flow_submit')) {
            return;
        }
        ...
        if (!empty($date_of_birth) && !$this->is_valid_date($date_of_birth)) wp_send_json(['ok' => false, 'message' => 'Enter a valid date of birth.']);
        if (!empty($date_of_birth) && $date_of_birth > current_time('Y-m-d')) wp_send_json(['ok' => false, 'message' => 'Date of birth cannot be in the future.']);
                        ...
                        <div class="crm-step" id="crm-step-details">
                            ...
                            <div class="crm-d-grid">
                                <div>
                                    ...
                                    <div class="crm-row2"><div class="crm-field"><label>Date of Birth</label><input type="date" class="crm-input" id="crm-date-of-birth"></div><div class="crm-field"></div></div>
                                ...
                                <aside class="crm-summary">
                                    ...
                                    <?php echo crm_booking_render_recaptcha_field('crm-booking-flow-recaptcha-v2'); ?>
